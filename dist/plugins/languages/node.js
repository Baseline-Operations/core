...
const nodePlugin = {
    metadata: {
        ...
        version: "1.0.0",
        description: "Node.js, TypeScript, and JavaScript support with npm/pnpm/yarn package managers",
        type: "language",
    },
    getLanguageProfile(options = {}) {
        ...
        if (options.packageManager) {
            toolchain.push({
                ...
                ...(options.versionPolicies?.[options.packageManager] && {
                    versionPolicy: options.versionPolicies[options.packageManager],
                }),
            });
        }
        // Add TypeScript tool
        ...
        if (options.additionalTools) {
            toolchain.push(...options.additionalTools.map((tool) => ({
                name: tool.name,
    ...
    getPrompts() {
        return [
            ...
            },
            {
                ...
                skip: (state) => state.answers.nodeVersionType === "skip",
            },
            {
                type: "select",
                name: "pmVersionType",
            ...
            },
            {
                ...
                skip: (state) => state.answers.pmVersionType === "skip",
            },
            {
                type: "select",
                name: "tsVersionType",
            ...
            },
            {
                ...
                skip: (state) => state.answers.tsVersionType === "skip",
            },
        ];
    },
