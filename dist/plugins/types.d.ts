...
export interface LanguagePlugin {
     ...
     */
    discoverCommands?(repoPath: string, options?: {
     ...
     */
    getDetectionCommand?(toolName: string): {
        command: string;
        args?: string[];
    } | null;
    /**
     ...
     */
    getCommandRunner?(repoPath: string, options?: {
        packageManager?: string;
    }): Promise<{
        runner: string;
        args: string[];
...
export interface PackageManagerPlugin {
     ...
     */
    createWorkspaceConfig?(repos: Array<{
        path: string;
        name: string;
...
export interface EditorPlugin {
     ...
     */
    generateWorkspaceFile?(config: any, workspaceRoot: string): Promise<{
        file: string;
        content: string;
    }>;
}
 ...
 */
export type BaselinePlugin = LanguagePlugin | ProviderPlugin | PackageManagerPlugin | EditorPlugin;
/**
 ...
 */
export type PluginLoader = (path: string) => Promise<BaselinePlugin | PluginPackage>;
