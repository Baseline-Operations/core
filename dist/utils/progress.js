...
export class ProgressUtil {
     ...
     */
    static log(current, total, label, showPercentage = true) {
     ...
     */
    static createCallback(total, label) {
        return (current) => {
     ...
     * @param label Optional label
     */
    static spinner(current, total, label) {
        const frames = ["⠋", "⠙", "⠹", "⠸", "⠼", "⠴", "⠦", "⠧", "⠇", "⠏"];
     ...
     */
    static bar(current, total, width = 20) {
     ...
     */
    static logBar(current, total, label, width = 20) {
