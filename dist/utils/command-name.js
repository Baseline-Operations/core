 ...
 */
export function getCommandName(workspaceRoot = process.cwd()) {
 ...
 */
export async function createCommandExample(workspaceRoot = process.cwd()) {
    const { mkdir, writeFile } = await import("fs/promises");
    const commandExamplePath = join(workspaceRoot, ".baseline", "command.example");
