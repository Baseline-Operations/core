 ...
 */
export function normalizePackage(pkg, _workspaceRoot) {
    ...
    const normalized = {
        ...
        version: pkg.version,
        repository: pkg.repository, // Access repository from legacy structure
 ...
 */
export function normalizeRepo(repo, workspaceRoot) {
 ...
 */
export function parseVersionPolicy(version) {
 ...
 */
export function languagesConfigToVersionPolicies(languages) {
    if (!languages)
        return {};
    const policies = {};
 ...
 */
export function normalizeAllRepos(repos, workspaceRoot) {
