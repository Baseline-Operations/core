...
import { BaselineConfigSchema } from "../types/config.js";
...
export class ConfigManager {
    ...
    async load() {
        ...
        try {
            ...
            throw new Error(`Failed to load baseline config: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    /**
    ...
    async save(config) {
        try {
            ...
            throw new Error(`Failed to save baseline config: ${error instanceof Error ? error.message : String(error)}`);
        }
    }
    /**
